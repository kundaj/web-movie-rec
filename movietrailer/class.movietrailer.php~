	...
	*/
	public function __construct($movie, $year)
	{
		...
		if($this->page)
		{
			...
			{
				$this->embed = '<embed src="http://www.youtube.com/v/'.$this->matches[1].'&autoplay=0&fs=1" type="application/x-shockwave-flash" wmode="transparent" allowfullscreen="true" width="557" height="361"></embed>';
				echo $this->embed;
			}
		}
		else
		{
			echo "<b>".$this->movieName."</b><br>";
			echo "<b>".$this->movieYear."</b><br>";
